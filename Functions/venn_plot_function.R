...
# This function takes in the data list generated by running the novel.probability function and 
# generates a plot with estimated frequencies for each novelty group.
