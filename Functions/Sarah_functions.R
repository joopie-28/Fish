...
# This function is to create a single matrix based on a timeseries ID
create.seasonal.ssmat <- function(n.ID, Survey_Data){
...
# This one applies the matrix function to all timeseries 
...
# This applies novelty detection to all processed matrices
...
# This creates a merged output frame which could be used for modelling etc
